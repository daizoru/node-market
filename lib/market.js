...
(function() {
  var Bond, Market, P, Product, Security, Session, Stock, UNIT, crypto, delay, humanize, inspect, log, penny, randfloat, randint, timmy,
  ...
  randfloat = exports.randfloat = function(max, min) {
    if (min == null) {
      min = 0;
    }
  ...
  randint = exports.randint = function(max, min) {
    if (min == null) {
      min = 0;
    }
  ...
  Market = (function() {
    ...
    function Market(args) {
      var account, login, product, symbol, _ref, _ref1,
        _this = this;
      if (args == null) {
        args = {};
      }
