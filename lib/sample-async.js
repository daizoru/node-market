...
(function() {
  var Market, Product, Stock, async, balance, buy, humanize, inspect, log, login, market, sell, workflow, _ref;

  inspect = require('util').inspect;

  log = console.log;

  _ref = require('./market'), Market = _ref.Market, Stock = _ref.Stock, Product = _ref.Product, humanize = _ref.humanize;
